...
; True when the dialog is 0x008QQQ + suffix for this quest ID.
...
; True when the quest is in the log and still needs its complete dialog.
...
; True in a town / outpost. False in explorables and while loading.
