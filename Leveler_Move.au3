...
Func Leveler_StepOutpost($a_i_Step)
	Switch $a_i_Step
		Case $LEVELER_STEP_PARTY, $LEVELER_STEP_SECONDARY, $LEVELER_STEP_XUNLAI, $LEVELER_STEP_WEAPON, $LEVELER_STEP_ARMOR, $LEVELER_STEP_DESTROY, $LEVELER_STEP_BAGS, $LEVELER_STEP_SKILLS, $LEVELER_STEP_ROAD
		...
		Case $LEVELER_STEP_THREAT
			If Leveler_HasQuest($QUEST_THREAT_GROWS) Or Leveler_HasQuest($QUEST_JOURNEY_MASTER) Then Return $MAP_SHING_JEA
			Return $MAP_RAN_MUSU
...
Func Leveler_StepAllowsMap($a_i_Step, $a_i_Map)
	...
	Switch $a_i_Step
		...
		Case $LEVELER_STEP_THREAT
			Return $a_i_Map = $MAP_KINYA Or $a_i_Map = $MAP_RAN_MUSU Or $a_i_Map = $MAP_SUNQUA_VALE Or $a_i_Map = $MAP_TSUMEI Or $a_i_Map = $MAP_PANJIANG
