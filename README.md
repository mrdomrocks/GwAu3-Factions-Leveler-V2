...
11. After Zen, **Complete Skills Training** walks to **Michiko npc id 62 at 420,1388** in Kaineng Center. Match PlayerNumber/agent 62, then name, then the nearest talk NPC at that point. Talk + buy via the same-page PendingMove slot (`CommandDialog` / `DIALOG_SEND 0x0Axxxxxx`). Also buy Zhao Di skills (SoD / Leech) if they were skipped by the story floor. Log `Trainer skills learnt: SoD=… Cry=…`. Do not treat account-unlocked skills as this character having learnt them.
