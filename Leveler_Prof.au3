...
Global Const $LEVELER_BAR_CAPTURE = 3
...
Func Leveler_ProfessionSkillBar($a_i_Kind, $a_i_Prof = 0)
	...
	Switch $a_i_Kind
		...
		Case $LEVELER_BAR_INTERRUPT
			; Domination 12: Cry of Pain, Power Drain, Signet of Disruption
			Switch $a_i_Prof
				Case $GC_I_PROFESSION_WARRIOR
		...
		Case $LEVELER_BAR_INSPIRE
			...
			EndSwitch
			Return "OQUCErwSOw1ZQPoBoQRIA"
		Case $LEVELER_BAR_CAPTURE
			Switch $a_i_Prof
				Case $GC_I_PROFESSION_WARRIOR
					Return "OQIAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_RANGER
					Return "OgAAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_MONK
					Return "OwIAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_NECROMANCER
					Return "OAJAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_MESMER
					Return "OQJAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_ELEMENTALIST
					Return "OgJAEbGAAAAAAAAAAA"
				Case $GC_I_PROFESSION_RITUALIST
					Return "OAKkYRYRWCGxmBAAAAAAAAAA"
				Case $GC_I_PROFESSION_ASSASSIN
					Return "OwJkYRZ5XMGxmBAAAAAAAAAA"
			EndSwitch
			Return "OQIAEbGAAAAAAAAAAA"
	EndSwitch
	Return ""
...
Func Leveler_LoadCaptureSkillBar()
	Return Leveler_LoadProfessionSkillBar($LEVELER_BAR_CAPTURE)
EndFunc
